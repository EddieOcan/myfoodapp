...
const PhotoCameraView: React.FC<PhotoCameraViewProps> = ({ onPhotoTaken }) => {
  ...
  const getFlashIconName = () => {
    ...
    if (flashMode === 'auto') return 'flash-outline'; // O un'icona specifica per 'auto' se disponibile
    return 'flash-off';
  };
  ...
  if (!permission.granted) {
    return (
      <View style={[styles.container, styles.centered, { backgroundColor: colors.background }]}>
        ...
        <TouchableOpacity style={[styles.closeButton, styles.closeButtonAbsolute, {backgroundColor: 'rgba(0,0,0,0.3)'}]} onPress={() => onPhotoTaken(undefined)}>
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.controlsOverlay}>
          <TouchableOpacity style={styles.controlButtonTop} onPress={() => onPhotoTaken(undefined)}>
